...
- **GitHub:** public repo `arifshekhk8/Techathon2026-Straw_Hat-Final`, initial commit pushed. Collaborator invites PENDING acceptance: meherabmehu, Anamika-Mallick, golammoula287 (they check github.com/notifications). If organizers mandate a different repo name, rename in Settings (redirects preserved).
